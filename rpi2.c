...
void rpi2_set_vectable()
{
	asm (
			...
			"ldr.w r2, irqset\n\t"
			"irqset_loop:\n\t"
			"ldr.w r3, [r0], #4 @ word auto-increment\n\t"
			"str.w r3, [r1], #4\n\t"
			"cmp.w r2, r0\n\t"
			"bhi irqset_loop\n\t"
...
{
	asm volatile(
			"str.w r0, [sp], #-4 @ push r0 - r0 is needed here\n\t"
			"ldr r0, =rpi2_reg_context @ r0 -> reg_context\n\t"
			"@ save the regs - we'll fix r0 and sp later\n\t"
			"stmia.w r0, {r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12}\n\t"
			"str.w r13, [r0, #+13*4] @ SP not allowed in thumb-stmia\n\t"
			"str.w r14, [r0, #+14*4] @ SP not allowed in thumb-stmia\n\t"
			"@ two more working registers, now that they are already saved\n\t"
			"str.w r1, [sp], #-4 @ push r1\n\t"
			"str.w r2, [sp], #-4 @ push r2\n\t"
			"eor r2,r2  @ clear exception_extra\n\t"
			"ldr.w r1, =exception_extra\n\t"
			"str.w r2, [r1]\n\t"
			...
			"str.w r0, [sp], #-4 @ push r0\n\t"
			"ldr.w r0, =exception_extra\n\t"
			"str.w r1, [r0]\n\t"
			"ldr.w r0, [sp, #+4]! @ pop r0\n\t"
			...
			"ldr.w r2, [sp, #+4]! @ pop r2\n\t"
			"ldr.w r1, [sp, #+4]! @ pop r1\n\t"
			"ldr.w r0, [sp, #+4]! @ pop r0\n\t"
	);
}
...
static inline void load_regs()
{
	asm volatile(
			...
			"ldmia.w r0, {r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12}\n\t"
			"ldr.w r13, [r0, #+13*4] @ SP not allowed in thumb-ldmia\n\t"
			...
			"ldr lr, [r0, #+15]\n\t"
			"ldr.w r1, [sp, #+4]! @ pop r0\n\t"
			"ldr.w r0, [sp, #+4]! @ pop r0\n\t"
			"subs.w pc, lr, #0 @ pc = lr - #0; cpsr = spsr\n\t"
	);
}
